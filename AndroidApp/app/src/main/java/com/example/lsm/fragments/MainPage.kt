...
import com.example.lsm.GeneralCategoriesList
import com.example.lsm.Words
import com.example.lsm.adapters.adapterSubCategories
import com.example.lsm.api.ApiService
import com.example.lsm.databinding.FragmentMainPageBinding
import com.example.lsm.storage.TechnicalCategoriesList
...
class MainPage : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchRVAdapter = adapterSubCategories(requireActivity(), dataList) {
            ...
            view.let { it1 -> Navigation.findNavController(it1).navigate(com.example.lsm.R.id.action_mainPage_frag_to_video_frag, bundle) }
        }
        ...
        binding.generalLanguageButton.setOnClickListener{
            ...
            view.findNavController().navigate(com.example.lsm.R.id.action_mainPage_frag_to_categories_frag, bundle)
        }
